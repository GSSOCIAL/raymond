...
$ss->assign('TITLE', $app_list_strings["moduleList"][$module] . ' - ' . $MBmod_strings['LBL_LISTVIEW']);


$displayed = $qutils->mobile['list'][$module];
...
$ss->assign('color_value', $qutils->mobile['marked'][$module]);
