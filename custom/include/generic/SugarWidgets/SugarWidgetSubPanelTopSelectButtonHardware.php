...
class SugarWidgetSubPanelTopSelectButtonHardware extends SugarWidgetSubPanelTopButton
{
	...
	function display($widget_data, $additionalFormFields = NULL, $nonbutton = false)
	{
		...
		if (!empty($focus->account_id)){
			$initial_filter .= '&ass_hardware_accounts_name_advanced='.$focus->account_name;
			$initial_filter .= '&ass_hardware_accountsaccounts_ida_advanced='.$focus->account_id;

		}

		file_put_contents('cache/widget.log', $initial_filter);
