...
class SugarWidgetSubPanelTopButtonQuickCreateHardware extends SugarWidgetSubPanelTopButton
{
	...
	function display($defines)
	{
		...
		if ($defines['focus']->object_name == 'Case') {
			if(isset($defines['focus']->account_name)) {
				$additionalFormFields['ass_hardware_accounts_name'] = $defines['focus']->account_name;
			}
			if(isset($defines['focus']->account_id)) {
				$additionalFormFields['ass_hardware_accountsaccounts_ida'] = $defines['focus']->account_id;
			}
		}
