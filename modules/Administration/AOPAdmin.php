...
$supportInternalEmailRoleDropdown = get_select_options_with_id($emailRoleList, $cfg->config['aop']['support_internal_email_role_id']);
$supportInternalEmailTemplateDropdown = get_select_options_with_id($emailTemplateList, $cfg->config['aop']['support_internal_email_template_id']);
