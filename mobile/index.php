...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/quickcrm5.4.css" />
        ...
        <script type="text/javascript" src="js/quickcrm-webutils-5.4.0.min.js"></script>
...
//	var conf_script=ServerAddress+'/index.php?entryPoint=QuickCRMgetConfig'+(trial!==false?'&trial=yes':'');
	...
	$.getScript(conf_script+"&param=sugar_config")
		.done(function(script, textStatus) {
			...
			$.cachedScript("js/quickcrm-web-5.4.1.min.js").done(function(script, textStatus) {
